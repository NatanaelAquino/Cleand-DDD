...
const AuthenticateAccountBodySchema = zod_1.z.object({
...
let AuthenticateController = class AuthenticateController {
    ...
    async handle(body) {
        ...
        if (!user) {
            throw new common_1.ConflictException(`User credentials do not match.`);
        }
...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_validation_pipi_1.ZodValidationPipe(AuthenticateAccountBodySchema)),
