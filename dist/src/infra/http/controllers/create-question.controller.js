...
const currrent_user_decorator_1 = require("../../auth/currrent-user-decorator");
const createQuestionBodySchema = zod_1.z.object({
    title: zod_1.z.string(),
    content: zod_1.z.string(),
});
const bodyValidationPipe = new zod_validation_pipi_1.ZodValidationPipe(createQuestionBodySchema);
...
__decorate([
    ...
    __param(1, (0, currrent_user_decorator_1.CurrentUser)()),
